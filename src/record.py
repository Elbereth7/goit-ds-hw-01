...
class Record:
    ...
    def remove_phone(self, phone):
        if phone in [p.value for p in self.phones]:
            ...
            raise ValueError(
                f"Removing phone {phone} failed. Phone {phone} not found for contact {self.name}"
            )
    ...
    def edit_phone(self, phone, new_phone):
        ...
        if not old_phone:
            raise ValueError(
                f"Editing phone {phone} failed. Phone {phone} not found for contact {self.name}"
            )
    ...
    def find_phone(self, phone):
        for p in self.phones:
            ...
            raise ValueError(
                f"Finding phone {phone} failed. Phone {phone} not found for contact {self.name}"
            )
